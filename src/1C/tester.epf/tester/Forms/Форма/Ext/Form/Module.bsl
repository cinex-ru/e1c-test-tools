...
// Конвертирует таблицу значений в массив структур
//
// Параметры:
//  Таблица				- ТаблицаЗначений	- Таблица для конвертации
//
// Возвращаемое значение:
//	Массив		- Полученный массив структур
//
&НаКлиенте
Функция ТаблицуЗначенийВМассивСтруктур(Таблица)
	Результат = Новый Массив;
...
&НаКлиенте
Функция ФункцияПреобразованияДляСериализацииВJSON(Свойство, Значение, ДополнительныеПараметры, Отказ) Экспорт
	Если ТипЗнч(Значение) = Тип("ТаблицаЗначений") Тогда
		Возврат ТаблицуЗначенийВМассивСтруктур(Значение);
	КонецЕсли;
	Отказ = Истина;
КонецФункции
...
Функция СериализоватьВJSON(Значение)
    ...
    ЗаписатьJSON(ЗаписьJSON, Значение,, "ФункцияПреобразованияДляСериализацииВJSON", ЭтаФорма);
